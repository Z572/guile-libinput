...
(begin
  ...
  (define-bytestructure-class
    ...
    libinput?))
(begin
  (define-public %libinput-device-struct
    (bs:unknow))
  (define-bytestructure-class
    <libinput-device>
    ()
    ...
    libinput-device?))
(begin
  (define-public %libinput-device-group-struct
    (bs:unknow))
  (define-bytestructure-class
...
(begin
  ...
  (define-bytestructure-class
    ...
    libinput-seat?))
(begin
  (define-public %libinput-tablet-tool-struct
    (bs:unknow))
  (define-bytestructure-class
    ...
    libinput-tablet-tool?))
(begin
  (define-public %libinput-event-struct
    (bs:unknow))
  (define-bytestructure-class
    <libinput-event>
    ()
    ...
    libinput-event?))
(begin
  (define-public %libinput-event-device-notify-struct
    (bs:unknow))
  (define-bytestructure-class
    ...
    libinput-event-device-notify?))
(begin
  (define-public %libinput-event-keyboard-struct
    (bs:unknow))
  (define-bytestructure-class
    ...
    libinput-event-keyboard?))
(begin
  (define-public %libinput-event-pointer-struct
    (bs:unknow))
  (define-bytestructure-class
    ...
    libinput-event-pointer?))
(begin
  (define-public %libinput-event-touch-struct
    (bs:unknow))
  (define-bytestructure-class
    ...
    libinput-event-touch?))
(begin
  (define-public %libinput-event-tablet-tool-struct
    (bs:unknow))
  (define-bytestructure-class
    ...
    libinput-event-tablet-tool?))
(begin
  (define-public %libinput-event-tablet-pad-struct
    (bs:unknow))
  (define-bytestructure-class
...
(begin
  ...
  (define-public (%libinput-device-capability-enum->number o)
    (bs:enum->integer
      %libinput-device-capability-enum
      o)))
(begin
...
(begin
  ...
  (define-public LIBINPUT_POINTER_AXIS_SCROLL_VERTICAL
    0)
  (define-public LIBINPUT_POINTER_AXIS_SCROLL_HORIZONTAL
    1)
...
(begin
  ...
  (define-public LIBINPUT_POINTER_AXIS_SOURCE_WHEEL
    1)
  (define-public LIBINPUT_POINTER_AXIS_SOURCE_FINGER
    2)
  (define-public LIBINPUT_POINTER_AXIS_SOURCE_CONTINUOUS
    3)
  (define-public LIBINPUT_POINTER_AXIS_SOURCE_WHEEL_TILT
    4)
  (define-public (%libinput-pointer-axis-source-enum->number o)
    (bs:enum->integer
      %libinput-pointer-axis-source-enum
      o)))
(begin
  ...
  (define-public LIBINPUT_TABLET_PAD_RING_SOURCE_UNKNOWN
    1)
  (define-public LIBINPUT_TABLET_PAD_RING_SOURCE_FINGER
    2)
  (define-public (%libinput-tablet-pad-ring-axis-source-enum->number
                  o)
    (bs:enum->integer
      %libinput-tablet-pad-ring-axis-source-enum
      o)))
(begin
  ...
  (define-public LIBINPUT_TABLET_PAD_STRIP_SOURCE_UNKNOWN
    1)
  (define-public LIBINPUT_TABLET_PAD_STRIP_SOURCE_FINGER
    2)
  (define-public (%libinput-tablet-pad-strip-axis-source-enum->number
                  o)
    (bs:enum->integer
      %libinput-tablet-pad-strip-axis-source-enum
      o)))
(begin
  ...
  (define-public LIBINPUT_TABLET_TOOL_TYPE_ERASER
    2)
  (define-public LIBINPUT_TABLET_TOOL_TYPE_BRUSH 3)
  (define-public LIBINPUT_TABLET_TOOL_TYPE_PENCIL
    4)
  (define-public LIBINPUT_TABLET_TOOL_TYPE_AIRBRUSH
    5)
  ...
  (define-public (%libinput-tablet-tool-type-enum->number o)
    (bs:enum->integer
      %libinput-tablet-tool-type-enum
      o)))
(begin
  ...
  (define-public LIBINPUT_TABLET_TOOL_PROXIMITY_STATE_OUT
    0)
  (define-public LIBINPUT_TABLET_TOOL_PROXIMITY_STATE_IN
    1)
  (define-public (%libinput-tablet-tool-proximity-state-enum->number
                  o)
    (bs:enum->integer
      %libinput-tablet-tool-proximity-state-enum
      o)))
(begin
  ...
  (define-public (%libinput-tablet-tool-tip-state-enum->number o)
    (bs:enum->integer
      %libinput-tablet-tool-tip-state-enum
      o)))
(begin
  (define-public %libinput-tablet-pad-mode-group-struct
    (bs:unknow))
  (define-bytestructure-class
...
(begin
  (define-public %libinput-event-switch-struct
    (bs:unknow))
  (define-bytestructure-class
...
(begin
  ...
  (define-public LIBINPUT_EVENT_POINTER_MOTION_ABSOLUTE
    401)
  (define-public LIBINPUT_EVENT_POINTER_BUTTON 402)
  (define-public LIBINPUT_EVENT_POINTER_AXIS 403)
  (define-public LIBINPUT_EVENT_POINTER_SCROLL_WHEEL
    404)
  (define-public LIBINPUT_EVENT_POINTER_SCROLL_FINGER
    405)
  (define-public LIBINPUT_EVENT_POINTER_SCROLL_CONTINUOUS
    406)
  ...
  (define-public LIBINPUT_EVENT_TABLET_TOOL_AXIS
    600)
  (define-public LIBINPUT_EVENT_TABLET_TOOL_PROXIMITY
    601)
  (define-public LIBINPUT_EVENT_TABLET_TOOL_TIP
    602)
  (define-public LIBINPUT_EVENT_TABLET_TOOL_BUTTON
    603)
  (define-public LIBINPUT_EVENT_TABLET_PAD_BUTTON
    700)
  (define-public LIBINPUT_EVENT_TABLET_PAD_RING
    701)
  (define-public LIBINPUT_EVENT_TABLET_PAD_STRIP
    702)
  (define-public LIBINPUT_EVENT_TABLET_PAD_KEY 703)
  (define-public LIBINPUT_EVENT_GESTURE_SWIPE_BEGIN
    800)
  (define-public LIBINPUT_EVENT_GESTURE_SWIPE_UPDATE
    801)
  (define-public LIBINPUT_EVENT_GESTURE_SWIPE_END
    802)
  (define-public LIBINPUT_EVENT_GESTURE_PINCH_BEGIN
    803)
  (define-public LIBINPUT_EVENT_GESTURE_PINCH_UPDATE
    804)
  (define-public LIBINPUT_EVENT_GESTURE_PINCH_END
    805)
  (define-public LIBINPUT_EVENT_GESTURE_HOLD_BEGIN
    806)
  (define-public LIBINPUT_EVENT_GESTURE_HOLD_END
    807)
  ...
  (let ((%func (ffi:pointer->procedure
    ...
    (lambda (event)
      (wrap-libinput-event-touch
        (%func (unwrap-libinput-event event))))))
(begin
  (define-public %libinput-event-gesture-struct
    (bs:unknow))
  (define-bytestructure-class
...
(define-public libinput-event-touch-get-time
  (let ((%func (ffi:pointer->procedure
                 ...
                 (list '*))))
    (lambda (event)
      (%func (unwrap-libinput-event-touch event)))))
...
(define-public libinput-event-touch-get-x-transformed
  (let ((%func (ffi:pointer->procedure
                 ...
                 (list '* ffi:uint32))))
    (lambda (event width)
      (%func (unwrap-libinput-event-touch event) width))))
...
(define-public libinput-event-gesture-get-time
  (let ((%func (ffi:pointer->procedure
                 ...
                 (list '*))))
    (lambda (event)
      (%func (unwrap-libinput-event-gesture event)))))
...
(define-public libinput-tablet-tool-has-button
  (let ((%func (ffi:pointer->procedure
                 ...
                 (list '* ffi:uint32))))
    (lambda (tool code)
      (%func (unwrap-libinput-tablet-tool tool) code))))
...
(define-public libinput-udev-create-context
  (let ((%func (ffi:pointer->procedure
    ...
    (lambda (interface user_data udev)
      (wrap-libinput
        (%func (unwrap-libinput-interface interface)
               user_data
               (#f udev))))))
...
(define-public libinput-log-get-priority
  (let ((%func (ffi:pointer->procedure
    ...
    (lambda (libinput)
      (%func (unwrap-libinput libinput)))))
(define-public libinput_log_handler
  (bs:pointer '*))
...
(define-public libinput-seat-ref
  (let ((%func (ffi:pointer->procedure
    ...
    (lambda (seat)
      (wrap-libinput-seat
        (%func (unwrap-libinput-seat seat))))))
...
(define-public libinput-seat-set-user-data
  (let ((%func (ffi:pointer->procedure
                 ...
                 (dynamic-func
                   ...
                   (force %libinput))
                 (list '* '*))))
    (lambda (seat user_data)
      (%func (unwrap-libinput-seat seat) user_data))))
...
(define-public libinput-device-get-udev-device
  (let ((%func (ffi:pointer->procedure
                 ...
                 (list '*))))
    (lambda (device)
      (#f (%func (unwrap-libinput-device device))))))
...
(define-public libinput-device-has-capability
  (let ((%func (ffi:pointer->procedure
    ...
    (lambda (device capability)
      (%func (unwrap-libinput-device device)
             (%libinput-device-capability-enum->number
               capability)))))
...
(define-public libinput-device-pointer-has-button
  (let ((%func (ffi:pointer->procedure
                 ...
                 (list '* ffi:uint32))))
    (lambda (device code)
      (%func (unwrap-libinput-device device) code))))
...
(begin
  ...
  (define-public LIBINPUT_CONFIG_STATUS_UNSUPPORTED
    1)
...
(begin
  ...
  (define-public (%libinput-config-tap-state-enum->number o)
    (bs:enum->integer
      %libinput-config-tap-state-enum
      o)))
...
(begin
  ...
  (define-public (%libinput-config-tap-button-map-enum->number o)
    (bs:enum->integer
      %libinput-config-tap-button-map-enum
      o)))
(define-public libinput-device-config-tap-set-button-map
  (let ((%func (ffi:pointer->procedure
    ...
    (lambda (device map)
      (%func (unwrap-libinput-device device)
             (%libinput-config-tap-button-map-enum->number
               map)))))
...
(begin
  ...
  (define-public (%libinput-config-drag-state-enum->number o)
    (bs:enum->integer
      %libinput-config-drag-state-enum
      o)))
...
(begin
  ...
  (define-public LIBINPUT_CONFIG_DRAG_LOCK_DISABLED
    0)
  (define-public LIBINPUT_CONFIG_DRAG_LOCK_ENABLED
    1)
  (define-public (%libinput-config-drag-lock-state-enum->number o)
    (bs:enum->integer
      %libinput-config-drag-lock-state-enum
      o)))
(define-public libinput-device-config-tap-set-drag-lock-enabled
  (let ((%func (ffi:pointer->procedure
    ...
    (lambda (device enable)
      (%func (unwrap-libinput-device device)
             (%libinput-config-drag-lock-state-enum->number
               enable)))))
    ...
    (bs:enum
      '((LIBINPUT_CONFIG_SEND_EVENTS_ENABLED 0)
        ...
        (LIBINPUT_CONFIG_SEND_EVENTS_DISABLED_ON_EXTERNAL_MOUSE
          2))))
  (define-public LIBINPUT_CONFIG_SEND_EVENTS_ENABLED
    0)
  (define-public LIBINPUT_CONFIG_SEND_EVENTS_DISABLED
    1)
  (define-public LIBINPUT_CONFIG_SEND_EVENTS_DISABLED_ON_EXTERNAL_MOUSE
    2)
  (define-public (%libinput-config-send-events-mode-enum->number
                  o)
    (bs:enum->integer
      %libinput-config-send-events-mode-enum
      o)))
...
(begin
  ...
  (define-public LIBINPUT_CONFIG_ACCEL_PROFILE_NONE
    0)
  (define-public LIBINPUT_CONFIG_ACCEL_PROFILE_FLAT
    1)
  (define-public LIBINPUT_CONFIG_ACCEL_PROFILE_ADAPTIVE
    2)
  (define-public (%libinput-config-accel-profile-enum->number o)
    (bs:enum->integer
      %libinput-config-accel-profile-enum
      o)))
...
(define-public libinput-device-config-accel-set-profile
  (let ((%func (ffi:pointer->procedure
    ...
    (lambda (device profile)
      (%func (unwrap-libinput-device device)
             (%libinput-config-accel-profile-enum->number
               profile)))))
...
(begin
  ...
  (define-public LIBINPUT_CONFIG_CLICK_METHOD_NONE
    0)
  (define-public LIBINPUT_CONFIG_CLICK_METHOD_BUTTON_AREAS
    1)
  (define-public LIBINPUT_CONFIG_CLICK_METHOD_CLICKFINGER
    2)
  (define-public (%libinput-config-click-method-enum->number o)
    (bs:enum->integer
      %libinput-config-click-method-enum
      o)))
...
(define-public libinput-device-config-click-set-method
  (let ((%func (ffi:pointer->procedure
    ...
    (lambda (device method)
      (%func (unwrap-libinput-device device)
             (%libinput-config-click-method-enum->number
               method)))))
...
(begin
  ...
  (define-public LIBINPUT_CONFIG_MIDDLE_EMULATION_DISABLED
    0)
  (define-public LIBINPUT_CONFIG_MIDDLE_EMULATION_ENABLED
    1)
  (define-public (%libinput-config-middle-emulation-state-enum->number
                  o)
    (bs:enum->integer
      %libinput-config-middle-emulation-state-enum
      o)))
...
(define-public libinput-device-config-scroll-set-method
  (let ((%func (ffi:pointer->procedure
    ...
    (lambda (device method)
      (%func (unwrap-libinput-device device)
             (%libinput-config-scroll-method-enum->number
               method)))))
...
(begin
  ...
  (define-public LIBINPUT_CONFIG_SCROLL_BUTTON_LOCK_DISABLED
    0)
  (define-public LIBINPUT_CONFIG_SCROLL_BUTTON_LOCK_ENABLED
    1)
  (define-public (%libinput-config-scroll-button-lock-state-enum->number
                  o)
    (bs:enum->integer
      %libinput-config-scroll-button-lock-state-enum
      o)))
...
(begin
  ...
  (define-public (%libinput-config-dwt-state-enum->number o)
    (bs:enum->integer
      %libinput-config-dwt-state-enum
      o)))
